      ...
      <div id="printArea"  ref={pdfRef} className=" bg-white shadow-lg rounded-lg ">
        <div className="flex items-center justify-between px-6 py-2 ">
          <div className="">
            ...
            <p className="font-medium text-gray-600">{data.voucher_id}</p>
          </div>
          <div className="text-end ">
            <p className="text-sm text-gray-800 font-bold mb-1">Invoice to</p>
            <p className="text-sm text-gray-600 mb-1">{data.customer_name}</p>
            <p className="text-xs text-gray-600 mb-1">Date: {data.sale_date}</p>
          </div>
        </div>
          ...
          <table className="w-full">
            <thead className="">
              <tr className="border-b-2 border-gray-400 ">
                ...
                <th className="text-right text-sm pb-4">Qty</th>
            ...
            <tbody className="">
              {data.records.map((record, index) => (
                <tr key={index} className="border-b border-gray-200">
                  ...
                  <td className="text-right text-sm py-3">{record.quantity}</td>
            ...
            <tfoot>
              ...
              <tr className=" border-gray-200">
                ...
                <th className="text-right text-sm text-gray-700">{data.tax.toFixed(2)}$</th>
              </tr>
              <tr className=" border-gray-200">
                <th colSpan="4" className="text-end text-sm pr-5 text-gray-700">
                  Net Total
